...
function buildLocaleBridgeScript(locale: string, target: "openclaw" | "paperclip"): string {
  const openClawTranslations: Record<string, Record<string, string>> = {
    ...
    ja: {
      ...
      "Broadcast Strategy": "\u30d6\u30ed\u30fc\u30c9\u30ad\u30e3\u30b9\u30c8\u6226\u7565",
      "Delivery order for broadcast fan-out: \"parallel\" sends to all targets concurrently, while \"sequential\" sends one-by-one. Use \"parallel\" for speed and \"sequential\" for stricter ordering/backpressure control.": "\u30d6\u30ed\u30fc\u30c9\u30ad\u30e3\u30b9\u30c8\u5206\u914d\u306e\u914d\u4fe1\u9806\u5e8f\uff1a\u300cparallel\u300d\u306f\u3059\u3079\u3066\u306e\u5b9b\u5148\u3078\u540c\u6642\u914d\u4fe1\u3001\u300csequential\u300d\u306f\u9806\u756a\u306b\u914d\u4fe1\u3057\u307e\u3059\u3002\u901f\u5ea6\u3092\u91cd\u8996\u3059\u308b\u306a\u3089\u300cparallel\u300d\u3001\u9806\u5e8f\u5236\u5fa1\u3092\u91cd\u8996\u3059\u308b\u306a\u3089\u300csequential\u300d\u3092\u4f7f\u3063\u3066\u304f\u3060\u3055\u3044\u3002",
      parallel: "\u4e26\u5217",
      sequential: "\u9806\u6b21",
      "Custom entries": "\u30ab\u30b9\u30bf\u30e0\u30a8\u30f3\u30c8\u30ea",
      "Add Entry": "\u30a8\u30f3\u30c8\u30ea\u8ffd\u52a0",
      "No custom entries.": "\u30ab\u30b9\u30bf\u30e0\u30a8\u30f3\u30c8\u30ea\u306f\u3042\u308a\u307e\u305b\u3093\u3002",
      Audio: "\u30aa\u30fc\u30c7\u30a3\u30aa",
