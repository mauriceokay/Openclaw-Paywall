...
const PLANS = [
  {
    ...
    monthlyPrice: 15,
    yearlyPrice: 12,
    description: "Perfect for personal use with a managed shared cloud environment.",
    features: [
  ...
  },
  {
    ...
    monthlyPrice: 35,
    yearlyPrice: 28,
    description: "For power users who want full automation with their own dedicated cloud instance.",
    features: [
      ...
      "Priority Support",
      "Dedicated Instance per Workspace",
      "3 Workspaces",
    ],
    highlight: true,
  },
  {
    ...
    monthlyPrice: 79,
    yearlyPrice: 63,
    description: "Built for teams and agencies with dedicated instances and advanced collaboration.",
    features: [
      "Everything in Pro",
      "Dedicated Instances (Unlimited Workspaces)",
      "Team Member Access",
      "Custom Integrations",
      "Dedicated Support",
      "SLA Guarantee",
